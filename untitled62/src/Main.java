        ...
        switch (enter) {
                ...
                do {
                    ...
                    switch (ch) {
                        case 1:
                            ...
                            for (int i = 0; i < branchArrayList.size(); i++) {
                                ...
                                if (branchArrayList.get(i).getBranch_name().equals(branch)) {
                                    employeeArrayList.add(new Employee(id, name, employeeArrayList.get(i).getBranch_id(), branch));
                        ...
                        case 6:
                            ...
                            branch = scan.next();
                            transportationArrayList.add(new Transportation(id, name, branch));
            ...
            case 2:
                ...
                for (int i = 0; i < employeeArrayList.size(); i++) {
                    ...
                    if (employeeArrayList.get(i).getId() == id4) {
                ...
                do {
                    System.out.println("1). Add Customer \n" +
                            ...
                            "3). Add Cargo Status: \n" +
                            "4). EXIT\n" +
                            "5). List customerArrayList Customers\n" +
                            "6).List customerArrayList Shipment Informations");
                    System.out.println("Enter your choice : ");
                        ...
                        case 1:
                            ...
                            for (int i = 0; i < shipmentArrayList.size(); i++) {
                                ...
                                if (shipmentArrayList.get(i).getReceiver().equals(name)) {
                                    customerArrayList.add(new Customer(id, name, customerArrayList.get(i).getSender(), customerArrayList.get(i).getCustomer_id(), customerArrayList.get(i).getCurrent_place_customer(), customerArrayList.get(i).getShipment_id()));
